  ...
  , m_tabVisible(false)
{
    ...
    m_rcCentre.setTopLeft(
        QPoint((this->width() / 2) - (m_activeStickers.value(Centre).width() / 2), (this->height() / 2) - (m_activeStickers.value(Centre).height() / 2)));
    ...
    m_rcTab.setTopLeft(
        QPoint((this->width() / 2) - (m_activeStickers.value(Tab).width() / 2), (this->height() / 2) - (m_activeStickers.value(Tab).height() / 2)));
