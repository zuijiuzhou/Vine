 ...
 * class required) can be owned by IntrusivePtr<Derived>. Because the counter
 * lives inside the object, constructing an IntrusivePtr never allocates and
 * never throws.
 *
...
class RefCounted {
  ...
  public:
     ...
     *
     * @return The number of IntrusivePtr instances currently referencing this object.
     */
