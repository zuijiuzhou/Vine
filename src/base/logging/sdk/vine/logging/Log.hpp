 ...
 */
#define V_LOGT(...) ::base::logging::Log::defaultLogger().trace(::std::source_location::current(), __VA_ARGS__)
#define V_LOGD(...) ::base::logging::Log::defaultLogger().debug(::std::source_location::current(), __VA_ARGS__)
#define V_LOGI(...) ::base::logging::Log::defaultLogger().info(::std::source_location::current(), __VA_ARGS__)
#define V_LOGW(...) ::base::logging::Log::defaultLogger().warn(::std::source_location::current(), __VA_ARGS__)
#define V_LOGE(...) ::base::logging::Log::defaultLogger().error(::std::source_location::current(), __VA_ARGS__)
#define V_LOGC(...) ::base::logging::Log::defaultLogger().critical(::std::source_location::current(), __VA_ARGS__)
